#############################################################################
# Makefile for building: Snake_qt.app/Contents/MacOS/Snake_qt
# Generated by qmake (3.1) (Qt 6.5.1)
# Project:  Snake_qt.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Snake_qt.pro
#############################################################################
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		Snake_qt.pro Board.h \
		Snake.h \
		SnakeBoard.h \
		SnakeWindow.h Board.cpp \
		Snake.cpp \
		SnakeBoard.cpp \
		SnakeWindow.cpp \
		main.cpp
QMAKE_TARGET  = Snake_qt
DESTDIR       = 
TARGET        = Snake_qt.app/Contents/MacOS/Snake_qt

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 13.3
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/allan/Desktop/projekt/.qmake.stash
...
Snake_qt.app/Contents/MacOS/Snake_qt: ui_SnakeWindow.h $(OBJECTS)  
	@test -d Snake_qt.app/Contents/MacOS/ || mkdir -p Snake_qt.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Snake_qt.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.5.1_3/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.5.1_3/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.5.1_3/share/qt/mkspecs/common/macx.conf \
...
Snake_qt.app/Contents/PkgInfo: 
	@test -d Snake_qt.app/Contents || mkdir -p Snake_qt.app/Contents
	@$(DEL_FILE) Snake_qt.app/Contents/PkgInfo
	@echo "APPL????" > Snake_qt.app/Contents/PkgInfo
Snake_qt.app/Contents/Info.plist: 
	@test -d Snake_qt.app/Contents || mkdir -p Snake_qt.app/Contents
	@$(DEL_FILE) Snake_qt.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.Snake-qt,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.Snake-qt,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},13.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Snake_qt,g" -e "s,@LIBRARY@,Snake_qt,g" -e "s,\$${EXECUTABLE_NAME},Snake_qt,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Snake_qt.app/Contents/Info.plist

all: Makefile \
		Snake_qt.app/Contents/PkgInfo \
		Snake_qt.app/Contents/Info.plist Snake_qt.app/Contents/MacOS/Snake_qt
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Board.h Snake.h SnakeBoard.h SnakeWindow.h $(DISTDIR)/
	$(COPY_FILE) --parents Board.cpp Snake.cpp SnakeBoard.cpp SnakeWindow.cpp main.cpp $(DISTDIR)/
	$(COPY_FILE) --parents SnakeWindow.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_SnakeBoard.cpp moc_SnakeWindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_SnakeBoard.cpp moc_SnakeWindow.cpp
moc_SnakeBoard.cpp: SnakeBoard.h \
...
compiler_uic_make_all: ui_SnakeWindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_SnakeWindow.h
ui_SnakeWindow.h: SnakeWindow.ui \
		...
		Board.h \
		Snake.h
	/opt/homebrew/share/qt/libexec/uic SnakeWindow.ui -o ui_SnakeWindow.h
...
SnakeBoard.o: SnakeBoard.cpp SnakeBoard.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QFrame \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qframe.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QBasicTimer \
		/opt/homebrew/lib/QtCore.framework/Headers/qbasictimer.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SnakeBoard.o SnakeBoard.cpp

SnakeWindow.o: SnakeWindow.cpp SnakeWindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		ui_SnakeWindow.h \
		SnakeBoard.h \
		...
		Board.h \
		Snake.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SnakeWindow.o SnakeWindow.cpp

main.o: main.cpp SnakeWindow.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
...
moc_SnakeBoard.o: moc_SnakeBoard.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_SnakeBoard.o moc_SnakeBoard.cpp

moc_SnakeWindow.o: moc_SnakeWindow.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_SnakeWindow.o moc_SnakeWindow.cpp
